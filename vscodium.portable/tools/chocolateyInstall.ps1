...
$packageArgs = @{
    ...
    url64bit       = 'https://github.com/VSCodium/vscodium/releases/download/1.88.1.24104/VSCodium-win32-x64-1.88.1.24104.zip'
    unzipLocation  = $installationPath
    checksum64     = '1c60da5ce64707d528a6aea2dd7430787e8c26ba12510a086134105f7de180f7'
