...
$packageArgs = @{
    ...
    url64bit       = 'https://github.com/VSCodium/vscodium/releases/download/1.104.06114/VSCodium-win32-x64-1.104.06114.zip'
    unzipLocation  = $installationPath
    checksum64     = '5d66a73d867f59cc6a4390da1f6680ac75ca1e10032b83be4dd405b34a51d596'
