...
$packageArgs = @{
    ...
    url64bit       = 'https://github.com/VSCodium/vscodium/releases/download/1.104.06131/VSCodium-win32-x64-1.104.06131.zip'
    unzipLocation  = $installationPath
    checksum64     = 'e137b6818743e55e653c938117318ba2cccca03ff02776c98d0d182eb65cd1e1'
