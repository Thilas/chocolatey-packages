...
$packageArgs  = @{
    ...
    fileType       = 'exe'
    url            = 'https://github.com/sabnzbd/sabnzbd/releases/download/2.3.7RC1/SABnzbd-2.3.7RC1-win-setup.exe'
    silentArgs     = '/S'
    checksum       = '993c6c0325efc1f316d7a6828e5e54c509ab3822f4de97a1ffd46fd1adee57da'
    checksumType   = 'sha256'
    validExitCodes = @(0)
}
# *** Automatically filled ***
