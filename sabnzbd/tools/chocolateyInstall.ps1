...
$packageArgs = @{
    ...
    fileType       = 'exe'
    url            = 'https://github.com/sabnzbd/sabnzbd/releases/download/3.3.0Beta2/SABnzbd-3.3.0Beta2-win-setup.exe'
    silentArgs     = '/S'
    checksum       = 'b5b2d5c82790c53b87bad626f9c488cdf72bee3e3c97abac5f8a62b49ddbbd49'
    checksumType   = 'sha256'
    validExitCodes = @(0)
}
# *** Automatically filled ***
